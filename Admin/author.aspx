<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="author.aspx.cs" Inherits="Admin_author" %>
            ...
            <div class="panel with-nav-tabs panel-primary">
                <div class="panel-heading" id="two">
                        <ul class="nav nav-tabs">
                            <li class="active one"><a href="#tab1primary" style="font-size:20px" data-toggle="tab">New Request</a></li>
                            <li class="one"><a href="#tab2primary"  style="font-size:20px"  data-toggle="tab">Authors</a></li>
                        ...
                        <div class="tab-pane fade in active" id="tab1primary">
                            ...
                            <form>
                             ...
                             <asp:TextBox ID="txtAuthorName" runat="server" CssClass="form-control" placeholder="Author_Name " required="required"></asp:TextBox>
                              ...
                              <asp:TextBox ID="TxtAuthoremail" runat="server" CssClass="form-control" placeholder="Author email" required="required"></asp:TextBox>

                                </div>
                                <div class="form-group">
                                        <label for="exampleInputEmail1">IS_Main Author</label>
                                  <asp:TextBox ID="Txtmainauthor" runat="server" CssClass="form-control" placeholder="main author" required="required"></asp:TextBox>

                                    </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">country</label>
                               <asp:TextBox ID="txtcountry" runat="server" CssClass="form-control" placeholder="country" required="required"></asp:TextBox>
                                           ...
                                           <asp:Button ID="btnauthor" runat="server" Text="Submit" CssClass="btn btn-primary" />
                            </form>
